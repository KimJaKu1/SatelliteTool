...
fetch_MSAFE()
{
    ...
    # which reference the saveAnt date, not the file content, so sometimes
...
# saveAnt (overwriting) leap seconds file
fetch_URL $usno_ser7_url tai-utc.dat
 
# saveAnt (overwriting) Earth Orientation Parameters
...
# saveAnt (adding files) Marshall Solar Activity Future Estimation
...
# saveAnt (overwriting) CSSI space weather data
