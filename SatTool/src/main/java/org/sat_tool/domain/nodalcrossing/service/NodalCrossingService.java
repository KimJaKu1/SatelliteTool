package org.sat_tool.domain.nodalcrossing.service;
...
import org.sat_tool.domain.nodalcrossing.model.NodeEvent;
import org.sat_tool.domain.nodalcrossing.writer.NodalCrossingReportWriter;
...
public class NodalCrossingService {
    ...
    private final NodalCrossingReportWriter reportWriter;

    public NodalCrossingService(NodalCrossingReportWriter reportWriter) {
    ...
    private AbsoluteDate findLatitudeExtremumTime(
        ...
        int iL = HermiteEventUtils.lowerBound(tAbs, tL);
        int iR = HermiteEventUtils.upperBound(tAbs, tR) - 1;
    ...
    private double latitudeRadAtTime(
        ...
        PVCoordinates pv = HermiteEventUtils.pvAtTimeNoProp(t, tAbs, rEcef, vEcef);
    ...
    public void generateNCFile(List<NodalCrossing> passes, String satName, Path path) {
        reportWriter.writeReport(passes, satName, path);
    }
}
